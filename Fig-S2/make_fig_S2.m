...
% Synthetic MIZ obs
SMO(1,:) = obmean; 
SMO(2,:) = obmean+2*obvar1; 
SMO(1,:) = obmean-2*obvar1; 
...
for i = 1:6
    for j = 1:12
        ...
        tval(i,j) = ttest2(sens_MIZ(indices==i,j),SMO(:,j),'Vartype','unequal');
...
saveas(gcf,'/Users/chorvat/Dropbox (Brown)/Apps/Overleaf/Marginal-Ice-Zone-CMIP/Fig-S2/Fig-S2.pdf')
